            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!--    <input id="filename" class="form-control" type="text" style="width:200px;float:left" placeholder="New File name"/>
                     ...
                     -->
                        <asp:TextBox ID="filename" CssClass ="form-control" Width="200px" runat="server" placeholder="New File name" ></asp:TextBox>
                        <asp:TextBox ID="share_with" CssClass ="form-control" Width="200px" runat="server" placeholder="Share with"></asp:TextBox>
